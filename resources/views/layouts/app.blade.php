...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">DPL ERP</span>
            </a>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::segment(1) != '' ? 'collapsed' : null }}" href="{{ route('home') }}">
            ...
            @can('item-list')
                <li class="nav-item">
                    <a class="nav-link {{ Request::segment(1) != 'items' ? 'collapsed' : null }}"
                        data-bs-target="#items-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-people-fill"></i><span>Items</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
            ...
            @can('user-list')
                <li class="nav-item">
                    <a class="nav-link {{ Request::segment(1) != 'users' && Request::segment(1) != 'roles' ? 'collapsed' : null }}"
                        ...
                        @can('role-create')
                            <li>
                                <a href="{{ route('roles.create') }}">
                                    <i class="bi bi-circle"></i><span>Create new user role</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>DPL ERP</span></strong> - v 1.0.0 : All Rights Reserved!
        </div>
        <div class="credits">
    ...
    {{-- <script src="{{ asset('https://cdn.jsdelivr.net/npm/alpinejs@2.8.2/dist/alpine.js')}}"></script> --}}
