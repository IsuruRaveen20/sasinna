            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <form action="{{ route('users.search') }}" method="GET"
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control bg-light border-0 small" name="search"
                                        placeholder="user name or e-mail ..." aria-label="Search"
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-bordered table-striped table-hover text-nowrap" id="userTable"
                            ...
                            <tr>
                                <td><a href="{{ route('users.show',$user->id) }}"><b>{{
                                            $user->name }}</b></a>
                                </td>
                                <td>{{ $user->email }}</td>
                                <td>
