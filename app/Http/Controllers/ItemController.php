...
use App\Http\Livewire\Item\ItemTable;
...
class ItemController extends Controller
{
    ...
    /**
     * Display the index page for items.
     * @return \Illuminate\Http\Response
     */
    public function index()
    {
        // Pass the ItemTable Livewire component to the view
        // using the 'component' variable
        return view('items.index', [
            'component' => app(ItemTable::class)
        ]);
    }
